...
experiment_classify_0:
	sudo docker run --gpus all -v /home/luizzanini/data/cbct_DL/:/home/luiz/app/data --env-file .env -ti caries-cnn:train python3 main.py 64 100 0 cnn simple resnet18

experiment_classify_1:
	sudo docker run --gpus all -v /home/luizzanini/data/cbct_DL/:/home/luiz/app/data --env-file .env -ti caries-cnn:train python3 main.py 64 100 1 cnn simple resnet50
